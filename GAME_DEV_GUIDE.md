...
|---|---|
| 게임명 | 두뇌 짝 맞추기 |
| 경로 | `kidsbrainkr.github.io/image_matching/` |
| 배포 URL | https://kidsbrainkr.github.io/image_matching |
| 대상 | 아이들 / 교육 환경 |
...
| 버전 | 내용 |
|---|---|
| v4 | 서버 저장 (기관코드 + 반 이름 기반) |
| v5 | 친구 얼굴-얼굴 매칭 모드 (Mode 3) |
| v6 | 메인 페이지 (`index.html`) — 게임 목록 |
